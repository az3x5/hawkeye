...
def upgrade():
    ...
    op.create_table("pieces",
        ...
        sa.Column("analysis_id", pg.UUID(as_uuid=True), sa.ForeignKey("evidence.runs.analysis_id"), nullable=False),
    ...
    op.create_table("events",
        ...
        schema="evidence")
    op.create_index("ix_evidence_events_owner_cursor", "events", ["owner", "sequence"], schema="evidence")
